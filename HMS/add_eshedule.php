...
<html>
  <body>
  	<div class="container">
	<form method="post" action="process-eshedule.php">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="number"  name="e_id" placeholder="Enter Employee ID">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text"  name="shift" placeholder="Enter Shift">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
