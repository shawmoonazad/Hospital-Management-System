...
<html>
  <body>
  	<div class="container">
	<form method="post" action="process-notice.php">
		<div class="row">
      <div class="col-25">
        <label>Serial</label>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text"  name="dname" placeholder="Enter Department">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text"  name="assign_by" placeholder="Enter Assign By">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
